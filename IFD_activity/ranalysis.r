library(reshape2)
library(ggplot2)
setwd("C:/Users/user/source/repos/IDF-movers_fresh/IDF-movers_fresh")
data <- read.table("activity-evol.txt", sep="\t", header = F)
...
minwv = 0.2;     # minimal (weight) value
maxwv = 0.6;     # maximal (weight) value
